...
<link rel='stylesheet' id='theme-bbpress-css'
	...
	media='all' />
<link  id='theme-fontawesome-css' href="//maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet" media='all' >
<!--[if IE 7]>
...
<body class="home page page-id-1254 page-template-default run" itemscope
	...
	<div id="side-panel-pusher">
		...
		<!-- /#main-container -->
		<tiles:insertAttribute name="sidePanel" />
		<!-- /#side-panel-pusher -->
	</div>
</body>
<script type='text/javascript'
	src='<s:url value="/js/bbpress.editor.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/jquery.form.min.js"></s:url>'></script>
<script type='text/javascript'>
	/* <![CDATA[ */
	var _wpcf7 = {
		"loaderUrl" : "http:\/\/envision.wptation.com\/wp-content\/plugins\/contact-form-7\/images\/ajax-loader.gif",
		"sending" : "Sending ...",
		"cached" : "1"
	};
	/* ]]> */
...
<script type='text/javascript'>
	...
	var woocommerce_params = {
		...
		"update_order_review_nonce" : "b79fb0c3a6",
		"apply_coupon_nonce" : "dc000e99bb",
		"option_guest_checkout" : "yes",
		"checkout_url" : "\/wp-admin\/admin-ajax.php?action=woocommerce-checkout",
		"is_checkout" : "0",
		"update_shipping_method_nonce" : "949e140a6f",
		"cart_url" : "http:\/\/envision.wptation.com\/cart\/",
		"cart_redirect_after_add" : "no"
	};
	/* ]]> */
</script>
<script type='text/javascript'
	src='<s:url value="/js/woocommerce.min.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/jquery.cookie.min.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/cart-fragments.min.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/jquery.prettyPhoto.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/extensions.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/woocommerce.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/waypoints.min.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/waypoints-sticky.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/jquery.viewport.mini.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/jquery.fillparent.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/jquery.video_background.init.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/jquery.flexslider.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/platform.twitter.widgets.js"></s:url>'></script>
<script type='text/javascript'
	src='<s:url value="/js/jquery.jplayer.js"></s:url>'></script>
...
<script type="text/javascript">
	...
	if (styleElement.styleSheet) {
		...
		styleElement.appendChild(document
				.createTextNode(cloudfw_dynamic_css_code));
	}
...
<script type="text/javascript">
	// <![CDATA[
	cloudfw_load_css_file(
			'theme-css-jplayer',
			'http://envision.wptation.com/wp-content/themes/envision/includes/shortcodes/shortcode.video.html5/jplayer/skin/jplayer.skin.css');
